...
import { Avatar, Button, Input, Skeleton, Spinner, Tooltip } from "@nextui-org/react";
...
export default function ChatWindow({ chat, setChat, socket }) {
  ...
  const handleSendMessage = () => {
    ...
    mutateSendMessage({ role:'teacher',chatId: chat?._id, content: message });
  ...
  const handleReaction = (id, item) => {
    mutateSendReaction({role:"teacher",chatId:chat._id,id,item})
  };
  if (!chat) return null;
